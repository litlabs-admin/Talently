    ...
    >
      <Container>
        <Reveal>
          ...
          <h2
            id="compare-heading"
            className="mx-auto max-w-[13ch] text-center text-[28px] leading-[1.1] font-bold tracking-[-0.03em] text-ink sm:max-w-none sm:text-[34px] lg:text-display-lg"
          >
        ...
        {/* Card pair ------------------------------------------------- */}
        <div className="mx-auto mt-head-sm grid max-w-[1176px] grid-cols-1 lg:mt-head-lg lg:grid-cols-[1fr_120px_1fr]">
        ...
        <Reveal
          delay={200}
          className="mt-head-sm flex flex-col items-center justify-center gap-5 sm:flex-row sm:gap-[29px] lg:mt-head-md"
        >
