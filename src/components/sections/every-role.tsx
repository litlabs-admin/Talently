 ...
 * The section runs 1513px between the hairline bands. On the 1288px body
 * column it splits 652 | 17 | 619:
 *
 ...
 * section, it releases on its own at the closing hairline — no fixed
  ...
  return (
    <>
      ...
      <Section
        ...
        className="scroll-mt-[64px] bg-white pt-10 pb-16 sm:pt-12 lg:scroll-mt-[74px] lg:pt-0 lg:pb-[125px]"
      >
        <Container>
          <div className="lg:grid lg:grid-cols-[652px_619px] lg:gap-x-[17px]">
            ...
            <div className="lg:sticky lg:top-[92px] lg:self-start">
              <Reveal distance={28}>
                <h2
                  id="roles-heading"
                  className="text-[34px] leading-[1.12] font-bold tracking-[-0.025em] text-ink sm:text-[42px] lg:pt-[14px] lg:pl-[52px] lg:text-[50px] lg:leading-[62px] lg:tracking-[-0.02em]"
                >
                  Every Role You{" "}
            ...
            <div className="mt-10 lg:mt-0">
              ...
              <ul className="mt-8 border-b border-hairline lg:mt-[48px] lg:ml-[70px]">
                {ROLES.map((role, i) => (
...
/**
 * One role. 224px tall on the reference, hung off a top hairline:
 * 24 title / 11 blurb / 15 chip(50) / 13 link / 29 tail.
 */
function RoleRow({ role, index }: { role: Role; index: number }) {
  return (
    <Reveal as="li" distance={18} className="block border-t border-hairline">
      <div className="group pt-5 pb-6 lg:pt-[24px] lg:pb-[29px]">
        ...
        <p className="mt-2 text-[16px] leading-[1.45] text-ink lg:mt-[11px] lg:text-[18px] lg:leading-[26px]">
          {role.blurb}
        </p>
